...
<html lang="en">
  <head>
    ...
    <title>Update Project Staff</title>
                ...
                <div class="p-3 py-5">
                	<form name="addForm" action="" onsubmit="return validateForm()" method="post">
                		<div class="d-flex justify-content-between align-items-center mb-3">
	                        <h4 class="text-right">Update Project Staff</h4>
	                    </div>
	                    <div class="row mt-3">
	                        <div class="col-md-12">
	                        	<label class="labels">Id User<span style="color:red;">*</span></label>
	                    		<select class="custom-select" id="inputGroupSelect01" name="uid" id="uid"  onchange="uIdChange();" disabled> 
	                    			<option value="${projectUser.user.id }" disabled selected>${projectUser.user.id }</option>
	                     ...
	                     <div class="row mt-3">
	                        <div class="col-md-12">
	                    		...
	                    		<select class="custom-select" id="inputGroupSelect01" name="pid" disabled>
		                    		<option value="${projectUser.project.id }" disabled selected>${projectUser.project.id }</option>
		                    		<%
			                    		try{
	                    ...
	                    <div class="row mt-3">
	                        <div class="col-md-12">
	                        	...
	                        	<input type="text" class="datepicker_start" placeholder="yyyy-mm-dd" name="join_date" value="${projectUser.join_date }" readonly>
	                    ...
	                    <div class="row mt-3">
	                    	<div class="col-md-12">
								...
								<textarea type="text" class="form-control" name="join_description" aria-label="With textarea" >${projectUser.join_description }</textarea>
							</div>
	                    </div>
