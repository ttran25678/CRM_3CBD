                ...
                <div class="p-3 py-5">
                	<form action="" method="post">
                		<div class="d-flex justify-content-between align-items-center mb-3">
	                        <h4 class="text-right">Add New Project</h4>
	                    </div>
	                    <div class="row mt-3">
	                        <div class="col-md-12">
	                        	<label class="labels">Id</label>
	                        	<input type="text" class="form-control" placeholder="Auto generate" name="id" readonly>
	                        </div>
	                        <div class="col-md-12">
	                        	<label class="labels">Name<span style="color:red;">*</span></label>
	                        	<input type="text" class="form-control" placeholder="Name project" name="name" 
	                        ...
	                        <div class="col-md-12">
	                        	...
	                        	<input type="text" class="form-control" placeholder="description project" name="description">
	                    ...
	                    <div class="row mt-3">
	                        <div class="col-md-6">
	                        	...
	                        	<input type="text" class="datepicker_start" placeholder="yyyy-mm-dd" name="start_date" id="start_date" readonly>
	                        	
	                        </div>
	                        <div class="col-md-6">
	                        	<label class="labels">End date</label>
	                        	<input type="text" class="datepicker_end" placeholder="yyyy-mm-dd" name="end_date" id="end_date" readonly>
	                        </div>
	                    </div>
	                    <div class="row mt-3">
	                    	<div class="col-md-12">
	                    ...
	                    <div class="mt-5 text-center">
	                    	<button class="btn btn-primary profile-button" type="submit" onsubmit="return test()">Add</button>
	                    </div>
                	</form>
                </div>
            </div>
